                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            ...
                            <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                <div class="sm:col-span-4">
                                    <div class="sm:col-span-4">
                                    <label for="username" class="block text-xl font-bold leading-6 text-green-500">ID Anime</label>
                                    <div class="mt-2">
                                        <div class="flex rounded-lg shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                            <input type="number" name="animeid" id="animeid" autocomplete="username" class="block rounded-md flex-1 border-0 bg-transparent py-1.5 pl-1 text-black-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 bg-white" placeholder="ID Anime">
                                        </div>
                                    </div>
                                </div>
                                    <label for="username" class=" mt-10 block text-xl font-bold leading-6 text-green-500">Nama Anime</label>
                                    <div class="mt-2">
                                        <div class="flex rounded-lg shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
